...
const StickySettings = ({ attributes, setAttributes, device }) => {
    ...
    return (
        <PanelBody
            title={__("Sticky", "table-of-content-block")}
            initialOpen={false}
        >
            <ToggleControl
            ...
            {sticky.toggle && (
                <>
                    ...
                    <PanelSelectControl
                        ...
                        onChange={(val) =>
                            setAttributes({
                                sticky: updateData(sticky, val, "device"),
                            })
                        }
                    />
                    ...
                    >
                        ...
                        <RangeUnitControl
                            ...
                            min={0}
                            max={
                                sticky[sticky.horizonAlign][device].includes(
                                    "px"
                                )
                                    ? 1000
                                    : 100
